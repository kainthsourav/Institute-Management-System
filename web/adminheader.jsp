...
<body class="home">
    <header id="header">
      ...
      <% if(session.getAttribute("admin")!=null)
        ...
        out.println("<span class='hidden-xs'>Welcome " +session.getAttribute("admin") + "</span>");
        }
        else
        {
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-3">
                        <div id="logo">
                            <h1><a href="Awelcome.jsp"><img src="images/log.png"/></a></h1>
                        </div>
                    </div>
                    <!-- Navigation
                    ================================================== -->
                    <div class="col-lg-9 col-sm-9 navbar navbar-default navbar-static-top container" role="navigation">
                        ...
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                <li class="active"><a href="Awelcome.jsp"><span class="data-hover"data-hover="home">home</span></a>
                                ...
                                <li><a href="#"><span class="data-hover" data-hover="Add">Add</span></a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="addtea.jsp">Add Teacher</a></li>
                                    </ul>
                                </li>
                                <li><a href="#" ><span class="data-hover" data-hover="Access Management">Access Management</span></a>
                                         <ul class="dropdown-menu">
                                                <li><a href="tlogin.jsp">Teacher Login</a></li>
                                                <li><a href="slogin.jsp">Student Login</a></li>
                                                <li><a href="remove.jsp">Manage</a></li>
                                          </ul>
                                </li>
                                <li><a href="#" ><span class="data-hover" data-hover="View/Update/Delete">View/Update/Delete</span></a>
                                         <ul class="dropdown-menu">
                                                <li><a href="tlist.jsp">List Of Teachers</a></li>
                                                <li><a href="slist.jsp">List of Students</a></li>
                                          </ul>
                                </li>
                                <li><a href="#"> <span class="data-hover" data-hover="Account">Account</span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="pass2.jsp">Change Password</a></li>
