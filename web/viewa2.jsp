...
<section class="wrapper">
    ...
    <tr><td>&nbsp;</td>
        <td>&nbsp;</td></tr>
      <tr>
          <td height="420"><form action="" method="post" name="form1" id="form1" onsubmit="return val();">
            ...
            Class.forName("com.mysql.jdbc.Driver");
              ...
              try
              {
                 ...
                 if(myresult.next())
                  ...
                  out.println("<tr><th>Class</th><th>Assignment</th><th>View"
                          + "</th></tr>");
                    do
                    {
                        out.println("<tr><td>" + myresult.getString("class") 
                                + "</td><td>" + myresult.getString("name") +"</td><td>" + "<a href='#'>" +"View"+"</a></td>" +
                                  "</td></tr>");
                    }
                    while(myresult.next());
                  out.println("</table>"); 
