      ...
      <tr>
          ...
          <table border="0" align="center" cellspacing="0" cellpadding="5">
            ...
            Class.forName("com.mysql.jdbc.Driver");
              ...
              try
              {
                  String q="select * from ttable where classid=?";
                 ...
                 if(myresult.next())
                  {
                  out.println("<table class='table table-striped table-hover' width='600' cellpadding=5 align=center cellspacing=0 border=0>");
                  out.println("<tr><th align=left>Name</th><th align=left>Gender</th><th align=left>Address"
                          + "</th></tr>");
                    do
                    {
                        out.println("<tr><td>" + myresult.getString("name") 
                                + "</td><td>" + myresult.getString("gender") + "<td>" +myresult.getString("address") 
                                +  "</td>"
                                + "</tr>");
                    }
                    while(myresult.next());
