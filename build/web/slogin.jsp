  ...
  <tr>
      ...
      <table width="40%" heignt="100%" border="0"align="center" cellpadding="5px" cellspacing="5px">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>
              <%if(request.getParameter("class9")!=null && request.getParameter("name1")!=null && request.getParameter("rollno")!=null )
        {
          try
            {
            Connection myconnection;
            ...
            try
            {
                String query2="select * from user where classid=? and name=? and rollno=?";
                ...
                mystatement2.setString(2,request.getParameter("name1"));
                 mystatement2.setString(3,request.getParameter("rollno"));
                ...
                PreparedStatement mystatement=myconnection.prepareStatement(query);
                 ...
                 mystatement.setString(3,request.getParameter("name1"));
                mystatement.setString(4,request.getParameter("Username"));
                mystatement.setString(5,request.getParameter("Password"));
                 mystatement.setString(6,("Student"));
        ...
        function val()
    {
       ...
       if(document.form1.class9.selectedIndex==0)
         ...
         {
              document.getElementById("m0").innerHTML="<font color=red>Select Student</font>";
             return false;
         }
         if(document.form1.rollno.selectedIndex==0)
         {
              document.getElementById("m9").innerHTML="<font color=red>Select Roll No</font>";
             return false;
         }
